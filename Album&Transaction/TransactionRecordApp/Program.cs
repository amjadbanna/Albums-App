...
builder.Services.AddDbContext<TransactionContext>(options => options.UseSqlite(connStr));
...
// For PostgreSQL:
// var connStr = builder.Configuration.GetConnectionString("TransactionsDbPostgres");
